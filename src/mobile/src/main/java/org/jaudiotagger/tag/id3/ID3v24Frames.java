...
public class ID3v24Frames extends ID3Frames
{
    ...
    private ID3v24Frames()
    {
        ...
        tagFieldToId3.put(FieldKey.LENGTH, ID3v24FieldKey.LENGTH);
        tagFieldToId3.put(FieldKey.USER_LYRICS, ID3v24FieldKey.USER_LYRICS);
        tagFieldToId3.put(FieldKey.USER_UNSYNCED_LYRICS, ID3v24FieldKey.USER_UNSYNCED_LYRICS);
