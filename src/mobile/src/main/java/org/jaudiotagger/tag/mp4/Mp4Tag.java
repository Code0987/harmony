...
public class Mp4Tag extends AbstractTag
{
    ...
    static
    {
        ...
        tagFieldToMp4Field.put(FieldKey.USER_LYRICS, Mp4FieldKey.USER_LYRICS);
        tagFieldToMp4Field.put(FieldKey.USER_UNSYNCED_LYRICS, Mp4FieldKey.USER_UNSYNCED_LYRICS);
    }
