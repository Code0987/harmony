...
public enum ID3v24FieldKey
{
    ...
    LENGTH(ID3v24Frames.FRAME_ID_LENGTH, Id3FieldType.TEXT),
    USER_LYRICS(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.LYRICS, Id3FieldType.TEXT),
    USER_UNSYNCED_LYRICS(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.UNSYNCED_LYRICS, Id3FieldType.TEXT),
    ;
