...
public class VorbisCommentTag extends AbstractTag
{
    ...
    static
    {
        ...
        tagFieldToOggField.put(FieldKey.USER_LYRICS, VorbisCommentFieldKey.USER_LYRICS);
        tagFieldToOggField.put(FieldKey.USER_UNSYNCED_LYRICS, VorbisCommentFieldKey.USER_UNSYNCED_LYRICS);
    }
