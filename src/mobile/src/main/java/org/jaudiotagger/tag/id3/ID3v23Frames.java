...
public class ID3v23Frames extends ID3Frames
{
    ...
    private ID3v23Frames()
    {
        ...
        tagFieldToId3.put(FieldKey.LENGTH, ID3v23FieldKey.LENGTH);
        tagFieldToId3.put(FieldKey.USER_LYRICS, ID3v23FieldKey.USER_LYRICS);
        tagFieldToId3.put(FieldKey.USER_UNSYNCED_LYRICS, ID3v23FieldKey.USER_UNSYNCED_LYRICS);
